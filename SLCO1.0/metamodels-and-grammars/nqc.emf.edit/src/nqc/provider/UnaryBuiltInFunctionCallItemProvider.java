...
/**
 * This is the item provider adapter for a {@link nqc.UnaryBuiltInFunctionCall} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UnaryBuiltInFunctionCallItemProvider
	 ...
	 * @generated
	 */
	public UnaryBuiltInFunctionCallItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addUnaryBuiltInFunctionPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Unary Built In Function feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addUnaryBuiltInFunctionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UnaryBuiltInFunctionCall_UnaryBuiltInFunction_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UnaryBuiltInFunctionCall_UnaryBuiltInFunction_feature", "_UI_UnaryBuiltInFunctionCall_type"),
				 NqcPackage.eINSTANCE.getUnaryBuiltInFunctionCall_UnaryBuiltInFunction(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NqcPackage.eINSTANCE.getUnaryBuiltInFunctionCall_Parameter());
		}
	...
	/**
	 * This returns UnaryBuiltInFunctionCall.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UnaryBuiltInFunctionCall"));
	}
	...
	public String getText(Object object) {
		BuiltInUnaryFunctionEnum labelValue = ((UnaryBuiltInFunctionCall)object).getUnaryBuiltInFunction();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_UnaryBuiltInFunctionCall_type") :
			getString("_UI_UnaryBuiltInFunctionCall_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UnaryBuiltInFunctionCall.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NqcPackage.eINSTANCE.getUnaryBuiltInFunctionCall_Parameter(),
