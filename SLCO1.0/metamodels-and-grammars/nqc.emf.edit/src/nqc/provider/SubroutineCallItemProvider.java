...
/**
 * This is the item provider adapter for a {@link nqc.SubroutineCall} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubroutineCallItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SubroutineCall_Callee_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SubroutineCall_Callee_feature", "_UI_SubroutineCall_type"),
				 NqcPackage.eINSTANCE.getSubroutineCall_Callee(),
				 true,
				 false,
				 true,
				 null,
