...
/**
 * This is the item provider adapter for a {@link nqc.SwitchStatement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SwitchStatementItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SwitchStatement_Condition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SwitchStatement_Condition_feature", "_UI_SwitchStatement_type"),
				 NqcPackage.eINSTANCE.getSwitchStatement_Condition(),
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NqcPackage.eINSTANCE.getSwitchStatement_Cases());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NqcPackage.eINSTANCE.getSwitchStatement_Cases(),
				 NqcFactory.eINSTANCE.createCase()));
	}
