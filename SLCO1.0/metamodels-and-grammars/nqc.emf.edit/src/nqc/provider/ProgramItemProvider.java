...
/**
 * This is the item provider adapter for a {@link nqc.Program} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProgramItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NqcPackage.eINSTANCE.getProgram_Name(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NqcPackage.eINSTANCE.getProgram_Tasks());
			childrenFeatures.add(NqcPackage.eINSTANCE.getProgram_Functions());
			childrenFeatures.add(NqcPackage.eINSTANCE.getProgram_Subroutines());
			childrenFeatures.add(NqcPackage.eINSTANCE.getProgram_GlobalVariables());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NqcPackage.eINSTANCE.getProgram_Tasks(),
				 NqcFactory.eINSTANCE.createTask()));

		newChildDescriptors.add
			(createChildParameter
				(NqcPackage.eINSTANCE.getProgram_Functions(),
				 NqcFactory.eINSTANCE.createFunction()));

		newChildDescriptors.add
			(createChildParameter
				(NqcPackage.eINSTANCE.getProgram_Subroutines(),
				 NqcFactory.eINSTANCE.createSubroutine()));

		newChildDescriptors.add
			(createChildParameter
				(NqcPackage.eINSTANCE.getProgram_GlobalVariables(),
