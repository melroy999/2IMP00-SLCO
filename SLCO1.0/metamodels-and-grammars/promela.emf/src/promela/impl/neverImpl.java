...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>never</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link promela.impl.neverImpl#getSequence <em>Sequence</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class neverImpl extends EObjectImpl implements never {
	/**
	...
	protected EClass eStaticClass() {
		return PromelaPackage.Literals.NEVER;
	}
	...
	public EList<step> getSequence() {
		if (sequence == null) {
			sequence = new EObjectContainmentEList<step>(step.class, this, PromelaPackage.NEVER__SEQUENCE);
		}
		return sequence;
	}
