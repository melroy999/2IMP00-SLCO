...
/**
 * This is the item provider adapter for a {@link poosl.Message} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MessageItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PooslPackage.Literals.MESSAGE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addParameterTypesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Message_parameterTypes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Message_parameterTypes_feature", "_UI_Message_type"),
				 PooslPackage.Literals.MESSAGE__PARAMETER_TYPES,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Message.class)) {
			case PooslPackage.MESSAGE__NAME:
