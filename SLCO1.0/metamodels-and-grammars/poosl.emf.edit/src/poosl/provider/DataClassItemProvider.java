...
/**
 * This is the item provider adapter for a {@link poosl.DataClass} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataClassItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PooslPackage.Literals.DATA_CLASS__VARIABLES);
			childrenFeatures.add(PooslPackage.Literals.DATA_CLASS__METHODS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PooslPackage.Literals.DATA_CLASS__VARIABLES,
				 PooslFactory.eINSTANCE.createVariable()));

		newChildDescriptors.add
			(createChildParameter
				(PooslPackage.Literals.DATA_CLASS__METHODS,
				 PooslFactory.eINSTANCE.createDataMethod()));
	}
