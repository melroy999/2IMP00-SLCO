 ...
 * <ul>
 *   <li>{@link slco.impl.SendSignalImpl#getPort <em>Port</em>}</li>
 *   <li>{@link slco.impl.SendSignalImpl#getSignalName <em>Signal Name</em>}</li>
 *   <li>{@link slco.impl.SendSignalImpl#getArguments <em>Arguments</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SendSignalImpl extends StatementImpl implements SendSignal {
	...
	protected EClass eStaticClass() {
		return SlcoPackage.Literals.SEND_SIGNAL;
	}
		...
		if (port != null && port.eIsProxy()) {
			...
			if (port != oldPort) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SlcoPackage.SEND_SIGNAL__PORT, oldPort, port));
			}
		}
		return port;
	}
	...
	public void setPort(Port newPort) {
		...
		port = newPort;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SlcoPackage.SEND_SIGNAL__PORT, oldPort, port));
	}
	...
	public void setSignalName(String newSignalName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SlcoPackage.SEND_SIGNAL__SIGNAL_NAME, oldSignalName, signalName));
	}
	...
	public EList<Expression> getArguments() {
		if (arguments == null) {
			arguments = new EObjectContainmentEList<Expression>(Expression.class, this, SlcoPackage.SEND_SIGNAL__ARGUMENTS);
		}
		return arguments;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SlcoPackage.SEND_SIGNAL__PORT:
