...
public class ChannelsAdapterFactory extends AdapterFactoryImpl {
	...
	protected ChannelsSwitch<Adapter> modelSwitch =
		new ChannelsSwitch<Adapter>() {
			...
			@Override
			public Adapter caseChannelLists(ChannelLists object) {
				return createChannelListsAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link channels.ChannelList <em>Channel List</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link channels.ChannelLists <em>Channel Lists</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createChannelListsAdapter() {
		return null;
	}
