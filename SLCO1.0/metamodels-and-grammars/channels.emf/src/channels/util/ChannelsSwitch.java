...
public class ChannelsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ChannelsPackage.CHANNEL_LIST: {
				ChannelList channelList = (ChannelList)theEObject;
				T result = caseChannelList(channelList);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ChannelsPackage.CHANNEL_LISTS: {
				ChannelLists channelLists = (ChannelLists)theEObject;
				T result = caseChannelLists(channelLists);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Channel Lists</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Channel Lists</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseChannelLists(ChannelLists object) {
		return null;
	}
