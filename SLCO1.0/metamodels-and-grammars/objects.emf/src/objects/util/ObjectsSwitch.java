...
public class ObjectsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ObjectsPackage.OBJECT_LISTS: {
				ObjectLists objectLists = (ObjectLists)theEObject;
				T result = caseObjectLists(objectLists);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ObjectsPackage.OBJECT_LIST: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Object Lists</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Object Lists</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseObjectLists(ObjectLists object) {
		return null;
	}
