...
public class ObjectsAdapterFactory extends AdapterFactoryImpl {
	...
	protected ObjectsSwitch<Adapter> modelSwitch =
		new ObjectsSwitch<Adapter>() {
			@Override
			public Adapter caseObjectLists(ObjectLists object) {
				return createObjectListsAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link objects.ObjectLists <em>Object Lists</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createObjectListsAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link objects.ObjectList <em>Object List</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
