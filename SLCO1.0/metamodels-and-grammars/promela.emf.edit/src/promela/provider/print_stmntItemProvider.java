...
/**
 * This is the item provider adapter for a {@link promela.print_stmnt} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class print_stmntItemProvider
	 ...
	 * @generated
	 */
	public print_stmntItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_print_stmnt_string_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_print_stmnt_string_feature", "_UI_print_stmnt_type"),
				 PromelaPackage.Literals.PRINT_STMNT__STRING,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PromelaPackage.Literals.PRINT_STMNT__ARG_LST);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/print_stmnt"));
	}
	...
	public String getText(Object object) {
		String label = ((print_stmnt)object).getLabel();
		return label == null || label.length() == 0 ?
			getString("_UI_print_stmnt_type") :
			getString("_UI_print_stmnt_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(print_stmnt.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PromelaPackage.Literals.PRINT_STMNT__ARG_LST,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == PromelaPackage.Literals.PRINT_STMNT__ARG_LST;
