...
/**
 * This is the item provider adapter for a {@link promela.options} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class optionsItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PromelaPackage.Literals.OPTIONS__SEQUENCE);
		}
	...
	public String getText(Object object) {
		return getString("_UI_options_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(options.class)) {
			case PromelaPackage.OPTIONS__SEQUENCE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PromelaPackage.Literals.OPTIONS__SEQUENCE,
