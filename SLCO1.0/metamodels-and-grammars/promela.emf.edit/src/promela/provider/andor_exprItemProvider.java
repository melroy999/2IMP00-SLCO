...
/**
 * This is the item provider adapter for a {@link promela.andor_expr} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class andor_exprItemProvider
	 ...
	 * @generated
	 */
	public andor_exprItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_andor_expr_operator_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_andor_expr_operator_feature", "_UI_andor_expr_type"),
				 PromelaPackage.Literals.ANDOR_EXPR__OPERATOR,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PromelaPackage.Literals.ANDOR_EXPR__OPERAND1);
			childrenFeatures.add(PromelaPackage.Literals.ANDOR_EXPR__OPERAND2);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/andor_expr"));
	}
	...
	public String getText(Object object) {
		String label = ((andor_expr)object).getLabel();
		return label == null || label.length() == 0 ?
			getString("_UI_andor_expr_type") :
			getString("_UI_andor_expr_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(andor_expr.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PromelaPackage.Literals.ANDOR_EXPR__OPERAND1,
		...
		newChildDescriptors.add
			(createChildParameter
				(PromelaPackage.Literals.ANDOR_EXPR__OPERAND2,
				 PromelaFactory.eINSTANCE.createvarref()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == PromelaPackage.Literals.ANDOR_EXPR__OPERAND1 ||
			childFeature == PromelaPackage.Literals.ANDOR_EXPR__OPERAND2;
