...
/**
 * This is the action bar contributor for the Poosl model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PooslActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(PooslEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			@Override
			public void run() {
				try {
	...
	protected IAction refreshViewerAction =
		new Action(PooslEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
			@Override
	 ...
	 * @generated
	 */
	public PooslActionBarContributor() {
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(PooslEditorPlugin.INSTANCE.getString("_UI_PooslEditor_menu"), "pooslMenuID");
