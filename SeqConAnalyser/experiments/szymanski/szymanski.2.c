...
void* thr1(void * arg) {
  while (1) {
    ...
    flag1 = 4;
    while (!(flag2 < 2 || flag3 < 2)) {};
    // begin critical section
    // end critical section
    while (!((2 > flag2 || flag2 > 3) && (2 > flag3 || flag3 > 3))) {};
    flag1 = 0;
  }
}
...
void* thr2(void * arg) {
  while (1) {
    ...
    flag2 = 4;
    while (!(flag1 < 2 && flag3 < 2)) {};
    // begin critical section
    // end critical section
    while (!((2 > flag1 || flag1 > 3) && (2 > flag3 || flag3 > 3))) {};
    flag2 = 0;
  }
}
...
void* thr3(void * arg) {
  while (1) {
    ...
    // begin critical section
    // end critical section
    while (!((2 > flag1 || flag1 > 3) && (2 > flag2 || flag2 > 3))) {};
    flag3 = 0;
  }
}
