...
public class SLCO2XMI2 {
	...
	public static void main(String[] args) {
	    ...
	    String absulotePath = "D:/GIT/SLCO/SLCOtoSLCO_Verification/eclipse_workspace/Example1/example_init_transformed";
	    // .ext ist the extension of the model file
	    String inputURI = "file:///" + absulotePath + ".slcotxt";
