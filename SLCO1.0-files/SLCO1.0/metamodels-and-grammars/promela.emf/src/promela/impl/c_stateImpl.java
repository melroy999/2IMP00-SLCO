 ...
 * <ul>
 *   <li>{@link promela.impl.c_stateImpl#getEmbedded_c_code <em>Embedded ccode</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class c_stateImpl extends stmntImpl implements c_state {
	/**
	...
	protected EClass eStaticClass() {
		return PromelaPackage.Literals.CSTATE;
	}
	...
	public void setEmbedded_c_code(String newEmbedded_c_code) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PromelaPackage.CSTATE__EMBEDDED_CCODE, oldEmbedded_c_code, embedded_c_code));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PromelaPackage.CSTATE__EMBEDDED_CCODE:
