...
/**
 * This is the item provider adapter for a {@link slco.StateMachine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateMachineItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SlcoPackage.Literals.STATE_MACHINE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SlcoPackage.Literals.STATE_MACHINE__VERTICES);
			childrenFeatures.add(SlcoPackage.Literals.STATE_MACHINE__TRANSITIONS);
			childrenFeatures.add(SlcoPackage.Literals.STATE_MACHINE__VARIABLES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SlcoPackage.Literals.STATE_MACHINE__VERTICES,
				 SlcoFactory.eINSTANCE.createFinal()));

		newChildDescriptors.add
			(createChildParameter
				(SlcoPackage.Literals.STATE_MACHINE__VERTICES,
				 SlcoFactory.eINSTANCE.createInitial()));

		newChildDescriptors.add
			(createChildParameter
				(SlcoPackage.Literals.STATE_MACHINE__VERTICES,
				 SlcoFactory.eINSTANCE.createState()));

		newChildDescriptors.add
			(createChildParameter
				(SlcoPackage.Literals.STATE_MACHINE__TRANSITIONS,
				 SlcoFactory.eINSTANCE.createTransition()));

		newChildDescriptors.add
			(createChildParameter
				(SlcoPackage.Literals.STATE_MACHINE__VARIABLES,
				 SlcoFactory.eINSTANCE.createVariable()));
	}
