...
/**
 * This is the item provider adapter for a {@link slco.Object} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ObjectItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SlcoPackage.Literals.OBJECT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addClassPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Object_class_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Object_class_feature", "_UI_Object_type"),
				 SlcoPackage.Literals.OBJECT__CLASS,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((slco.Object)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(slco.Object.class)) {
			case SlcoPackage.OBJECT__NAME:
