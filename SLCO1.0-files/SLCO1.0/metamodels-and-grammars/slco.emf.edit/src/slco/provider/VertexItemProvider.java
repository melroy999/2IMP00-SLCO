...
/**
 * This is the item provider adapter for a {@link slco.Vertex} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Vertex_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Vertex_name_feature", "_UI_Vertex_type"),
				 SlcoPackage.Literals.VERTEX__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SlcoPackage.Literals.VERTEX__INCOMING,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SlcoPackage.Literals.VERTEX__OUTGOING,
				 true,
				 false,
				 true,
				 null,
