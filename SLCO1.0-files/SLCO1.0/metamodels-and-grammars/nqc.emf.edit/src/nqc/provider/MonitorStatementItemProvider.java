...
/**
 * This is the item provider adapter for a {@link nqc.MonitorStatement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MonitorStatementItemProvider
	 ...
	 * @generated
	 */
	public MonitorStatementItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NqcPackage.eINSTANCE.getMonitorStatement_Events());
			childrenFeatures.add(NqcPackage.eINSTANCE.getMonitorStatement_Body());
			childrenFeatures.add(NqcPackage.eINSTANCE.getMonitorStatement_Handlers());
		}
	...
	/**
	 * This returns MonitorStatement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MonitorStatement"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_MonitorStatement_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MonitorStatement.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NqcPackage.eINSTANCE.getMonitorStatement_Events(),
				 NqcFactory.eINSTANCE.createEventTypeConstant()));

		newChildDescriptors.add
			(createChildParameter
				(NqcPackage.eINSTANCE.getMonitorStatement_Body(),
		...
		newChildDescriptors.add
			(createChildParameter
				(NqcPackage.eINSTANCE.getMonitorStatement_Handlers(),
				 NqcFactory.eINSTANCE.createMonitorHandler()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == NqcPackage.eINSTANCE.getMonitorStatement_Events() ||
			childFeature == NqcPackage.eINSTANCE.getMonitorStatement_Body();
