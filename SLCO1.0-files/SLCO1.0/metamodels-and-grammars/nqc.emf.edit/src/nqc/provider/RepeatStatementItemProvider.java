...
/**
 * This is the item provider adapter for a {@link nqc.RepeatStatement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RepeatStatementItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NqcPackage.eINSTANCE.getRepeatStatement_Condition());
			childrenFeatures.add(NqcPackage.eINSTANCE.getRepeatStatement_Body());
		}
	...
	public String getText(Object object) {
		return getString("_UI_RepeatStatement_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NqcPackage.eINSTANCE.getRepeatStatement_Condition(),
		...
		newChildDescriptors.add
			(createChildParameter
				(NqcPackage.eINSTANCE.getRepeatStatement_Body(),
				 NqcFactory.eINSTANCE.createAcquireConstant()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == NqcPackage.eINSTANCE.getRepeatStatement_Condition() ||
			childFeature == NqcPackage.eINSTANCE.getRepeatStatement_Body();
