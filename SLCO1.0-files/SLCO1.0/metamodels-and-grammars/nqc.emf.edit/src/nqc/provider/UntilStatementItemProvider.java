...
/**
 * This is the item provider adapter for a {@link nqc.UntilStatement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UntilStatementItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NqcPackage.eINSTANCE.getUntilStatement_Condition());
			childrenFeatures.add(NqcPackage.eINSTANCE.getUntilStatement_Body());
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UntilStatement.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NqcPackage.eINSTANCE.getUntilStatement_Condition(),
		...
		newChildDescriptors.add
			(createChildParameter
				(NqcPackage.eINSTANCE.getUntilStatement_Body(),
				 NqcFactory.eINSTANCE.createAcquireConstant()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == NqcPackage.eINSTANCE.getUntilStatement_Condition() ||
			childFeature == NqcPackage.eINSTANCE.getUntilStatement_Body();
