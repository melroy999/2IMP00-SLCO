...
/**
 * This is the item provider adapter for a {@link nqc.Task} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NqcPackage.eINSTANCE.getTask_Name(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NqcPackage.eINSTANCE.getTask_Statements());
			childrenFeatures.add(NqcPackage.eINSTANCE.getTask_LocalVariables());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NqcPackage.eINSTANCE.getTask_Statements(),
		...
		newChildDescriptors.add
			(createChildParameter
				(NqcPackage.eINSTANCE.getTask_LocalVariables(),
