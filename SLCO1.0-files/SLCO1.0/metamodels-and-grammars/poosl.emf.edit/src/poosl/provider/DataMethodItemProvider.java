...
/**
 * This is the item provider adapter for a {@link poosl.DataMethod} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataMethodItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataMethod_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataMethod_name_feature", "_UI_DataMethod_type"),
				 PooslPackage.Literals.DATA_METHOD__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PooslPackage.Literals.DATA_METHOD__VARIABLES);
	...
	public String getText(Object object) {
		String label = ((DataMethod)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DataMethod_type") :
			getString("_UI_DataMethod_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PooslPackage.Literals.DATA_METHOD__VARIABLES,
