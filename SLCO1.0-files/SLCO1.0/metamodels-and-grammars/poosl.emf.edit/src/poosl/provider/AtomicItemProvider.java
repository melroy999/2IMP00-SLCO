...
/**
 * This is the item provider adapter for a {@link poosl.Atomic} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AtomicItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Atomic_statements_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Atomic_statements_feature", "_UI_Atomic_type"),
				 PooslPackage.Literals.ATOMIC__STATEMENTS,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		return getString("_UI_Atomic_type");
	}
