...
/**
 * This is the item provider adapter for a {@link promela.pc_value_expr} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class pc_value_exprItemProvider
	 ...
	 * @generated
	 */
	public pc_value_exprItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PromelaPackage.Literals.PC_VALUE_EXPR__ANY_EXPR);
		}
	...
	/**
	 * This returns pc_value_expr.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/pc_value_expr"));
	}
	...
	public String getText(Object object) {
		String label = ((pc_value_expr)object).getLabel();
		return label == null || label.length() == 0 ?
			getString("_UI_pc_value_expr_type") :
			getString("_UI_pc_value_expr_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(pc_value_expr.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PromelaPackage.Literals.PC_VALUE_EXPR__ANY_EXPR,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == PromelaPackage.Literals.PC_VALUE_EXPR__ANY_EXPR;
