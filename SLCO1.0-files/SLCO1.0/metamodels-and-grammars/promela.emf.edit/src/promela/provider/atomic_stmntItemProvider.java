...
/**
 * This is the item provider adapter for a {@link promela.atomic_stmnt} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class atomic_stmntItemProvider
	 ...
	 * @generated
	 */
	public atomic_stmntItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PromelaPackage.Literals.ATOMIC_STMNT__SEQUENCE);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/atomic_stmnt"));
	}
	...
	public String getText(Object object) {
		String label = ((atomic_stmnt)object).getLabel();
		return label == null || label.length() == 0 ?
			getString("_UI_atomic_stmnt_type") :
			getString("_UI_atomic_stmnt_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(atomic_stmnt.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PromelaPackage.Literals.ATOMIC_STMNT__SEQUENCE,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == PromelaPackage.Literals.ATOMIC_STMNT__SEQUENCE;
