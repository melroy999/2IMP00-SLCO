...
/**
 * This is the item provider adapter for a {@link promela.assert_stmnt} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class assert_stmntItemProvider
	 ...
	 * @generated
	 */
	public assert_stmntItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PromelaPackage.Literals.ASSERT_STMNT__EXPR);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/assert_stmnt"));
	}
	...
	public String getText(Object object) {
		String label = ((assert_stmnt)object).getLabel();
		return label == null || label.length() == 0 ?
			getString("_UI_assert_stmnt_type") :
			getString("_UI_assert_stmnt_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(assert_stmnt.class)) {
			case PromelaPackage.ASSERT_STMNT__EXPR:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PromelaPackage.Literals.ASSERT_STMNT__EXPR,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == PromelaPackage.Literals.ASSERT_STMNT__EXPR;
