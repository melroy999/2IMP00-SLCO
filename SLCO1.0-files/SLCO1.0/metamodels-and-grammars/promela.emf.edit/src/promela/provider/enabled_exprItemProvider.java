...
/**
 * This is the item provider adapter for a {@link promela.enabled_expr} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class enabled_exprItemProvider
	 ...
	 * @generated
	 */
	public enabled_exprItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PromelaPackage.Literals.ENABLED_EXPR__ANY_EXPR);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/enabled_expr"));
	}
	...
	public String getText(Object object) {
		String label = ((enabled_expr)object).getLabel();
		return label == null || label.length() == 0 ?
			getString("_UI_enabled_expr_type") :
			getString("_UI_enabled_expr_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(enabled_expr.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PromelaPackage.Literals.ENABLED_EXPR__ANY_EXPR,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == PromelaPackage.Literals.ENABLED_EXPR__ANY_EXPR;
