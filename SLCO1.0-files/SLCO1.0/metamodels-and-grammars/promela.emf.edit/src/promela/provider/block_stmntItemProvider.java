...
/**
 * This is the item provider adapter for a {@link promela.block_stmnt} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class block_stmntItemProvider
	 ...
	 * @generated
	 */
	public block_stmntItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PromelaPackage.Literals.BLOCK_STMNT__SEQUENCE);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/block_stmnt"));
	}
	...
	public String getText(Object object) {
		String label = ((block_stmnt)object).getLabel();
		return label == null || label.length() == 0 ?
			getString("_UI_block_stmnt_type") :
			getString("_UI_block_stmnt_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(block_stmnt.class)) {
			case PromelaPackage.BLOCK_STMNT__SEQUENCE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PromelaPackage.Literals.BLOCK_STMNT__SEQUENCE,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == PromelaPackage.Literals.BLOCK_STMNT__SEQUENCE;
