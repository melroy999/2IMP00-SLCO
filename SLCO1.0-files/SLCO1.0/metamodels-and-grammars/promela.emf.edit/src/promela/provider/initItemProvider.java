...
/**
 * This is the item provider adapter for a {@link promela.init} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class initItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_init_priority_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_init_priority_feature", "_UI_init_type"),
				 PromelaPackage.Literals.INIT__PRIORITY,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PromelaPackage.Literals.INIT__SEQUENCE);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_init_type") + " " + init.getPriority();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(init.class)) {
			case PromelaPackage.INIT__PRIORITY:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case PromelaPackage.INIT__SEQUENCE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PromelaPackage.Literals.INIT__SEQUENCE,
