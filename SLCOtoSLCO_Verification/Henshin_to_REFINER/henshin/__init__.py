...
from . import henshin
from pyecore.ecore import EPackage, EClassifier, EClass, EReference, EAttribute
...
ConditionalUnit.cu_if.eType = Unit
ConditionalUnit.cu_then.eType = Unit
ConditionalUnit.cu_else.eType = Unit
